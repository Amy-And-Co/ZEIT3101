defmodule AmyandcoWeb.UserAuthTest do
  use AmyandcoWeb.ConnCase, async: true

  alias Amyandco.Account
  alias AmyandcoWeb.UserAuth
  import Amyandco.AccountFixtures

  @remember_me_cookie "_amyandco_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, AmyandcoWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      AmyandcoWeb.Endpoint.subscribe(live_socket_id)
